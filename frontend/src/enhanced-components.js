...
export const DiscoverPage = () => {
  ...
  // Mock performers data with diverse profiles
  const mockPerformers = [
    // WOMEN PROFILES (6 total including existing ones)
    {
      id: 1,
      firstName: "Isabella",
      lastName: "Rose",
    ...
    },
    {
      ...
      monthlyFee: 18.99,
      bundles: [
        { months: 3, price: 49.99, discount: 12 },
        { months: 6, price: 89.99, discount: 21 },
        { months: 12, price: 159.99, discount: 30 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      firstName: "Victoria",
      lastName: "Grace",
      displayName: "Victoria Grace",
      username: "@victoria_grace",
      ...
      monthlyFee: 34.99,
      bundles: [
        { months: 3, price: 94.99, discount: 9 },
        { months: 6, price: 179.99, discount: 14 },
        { months: 12, price: 329.99, discount: 22 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      monthlyFee: 22.99,
      bundles: [
        { months: 3, price: 62.99, discount: 8 },
        { months: 6, price: 119.99, discount: 13 },
        { months: 12, price: 219.99, discount: 20 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      firstName: "Dylan",
      lastName: "Phoenix",
      displayName: "Dylan Phoenix",
      username: "@dylan_phoenix",
      ...
      monthlyFee: 16.99,
      bundles: [
        { months: 3, price: 45.99, discount: 10 },
        { months: 6, price: 84.99, discount: 17 },
        { months: 12, price: 159.99, discount: 22 }
      ],
      isVerified: true,
      joinedDate: "2023-04-07",
      totalLikes: 378000,
      totalMedia: 445
    },
    {
      ...
      monthlyFee: 28.99,
      bundles: [
        { months: 3, price: 79.99, discount: 8 },
        { months: 6, price: 149.99, discount: 14 },
        { months: 12, price: 279.99, discount: 20 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      monthlyFee: 21.99,
      bundles: [
        { months: 3, price: 59.99, discount: 9 },
        { months: 6, price: 109.99, discount: 17 },
        { months: 12, price: 199.99, discount: 24 }
      ],
      isVerified: true,
    ...
    // TRANS PROFILES (6 total)
    {
      ...
      monthlyFee: 26.99,
      bundles: [
        { months: 3, price: 72.99, discount: 10 },
        { months: 6, price: 134.99, discount: 17 },
        { months: 12, price: 249.99, discount: 23 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      monthlyFee: 20.99,
      bundles: [
        { months: 3, price: 56.99, discount: 9 },
        { months: 6, price: 104.99, discount: 16 },
        { months: 12, price: 189.99, discount: 24 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      firstName: "Phoenix",
      lastName: "Vale",
      displayName: "Phoenix Vale",
      username: "@phoenix_vale",
      ...
      monthlyFee: 31.99,
      bundles: [
        { months: 3, price: 86.99, discount: 9 },
        { months: 6, price: 159.99, discount: 17 },
        { months: 12, price: 289.99, discount: 24 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      monthlyFee: 29.99,
      bundles: [
        { months: 3, price: 81.99, discount: 8 },
        { months: 6, price: 149.99, discount: 17 },
        { months: 12, price: 269.99, discount: 25 }
      ],
      isVerified: true,
    ...
    },
    {
      ...
      monthlyFee: 18.99,
      bundles: [
        { months: 3, price: 51.99, discount: 8 },
        { months: 6, price: 94.99, discount: 17 },
        { months: 12, price: 169.99, discount: 25 }
      ],
      isVerified: false,
    ...
    },
    {
      ...
      monthlyFee: 24.99,
      bundles: [
        { months: 3, price: 67.99, discount: 9 },
        { months: 6, price: 124.99, discount: 17 },
        { months: 12, price: 224.99, discount: 25 }
      ],
      isVerified: true,
